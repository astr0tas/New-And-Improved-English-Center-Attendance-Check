...
export default function ChangeEntity(props){
    ...
    return (
        <>
            <div className = 'entity-box'>
                {
                    showListClass && <ClassList offClassList = {()=>setShowListClass(false)} showNoti = {() => setShow(true)}  changeClass = {(value) => setClasses(value)}/>
                }
                {
            ...
            <div className = 'entity-list-container'>
                    {
                        ...
                        ? 
                            classList.map((_class) => (
                                <ClassDetails class = {_class} option = "full" showChange= {() => showChangeClass(false)} />
                            ))
                        : 
                            classList.map((_class) => (
                                <ClassDetails class = {_class} showChange = {() => handleChange(_class)}/>
                            ))
                    }
            </div>
