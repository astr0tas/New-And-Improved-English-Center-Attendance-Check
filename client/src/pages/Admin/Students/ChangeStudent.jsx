...
export default function ChangeStudent(props)
{
      ...
      return (
            <>
                  <div className='entity-box'>
                        ...
                        {
                              showNoti && <Noti offNoti={ () => setShow(false) } option="change" role = {"Student"}/>
                        }
...
function ClassList(props)
{
      ...
      axios.get("http://localhost:3030/admin/" + props.entity.ID + "/classes")
      .then(
      ...
      return (
            <div className='entity-container'>
                  <p>{ lclass.Name }</p>
                  {
                        props.option === "full" &&
                        <>
                              <p>{ lclass.Current_number_of_student }</p>
