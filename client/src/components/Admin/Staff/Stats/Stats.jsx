...
const Stats = (props) =>
{
      ...
      useEffect(() =>
      {
            if (props.showPopUp)
            {
                  request.post(`http://${ domain }/admin/teacherStats`, { params: { id: props.id, name: props.chosenClassName } }, { headers: { 'Content-Type': 'application/json' } })
                        .then(res =>
                        {
      ...
      return (
            <Modal show={ props.showPopUp } onHide={ () => { clearOut(); props.setShowPopUp(false); } }
                  ...
                  <Modal.Body className='d-flex flex-column align-items-center'>
                        ...
                        <h5 className='my-3'>Total responsible sessions: { totalSession ? totalSession : 'N/A' }</h5>
