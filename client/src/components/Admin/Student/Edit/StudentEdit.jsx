            ...
            <>
                  <Modal show={ props.showPopUp } onHide={ () => { props.setShowPopUp(false); clearOut(); } }
                        ...
                        <Modal.Body>
                              ...
                              <div className={ `row ${ invalidDate ? 'mt-1' : 'mt-5' }` }>
                                    ...
                                    <div className='col d-flex align-items-center justify-content-center justify-content-sm-start'>
                                          <input defaultValue={ oldBirthplace ? oldBirthplace : '' } placeholder={ oldBirthplace ? oldBirthplace : '' } type='text' className={ `${ styles.inputs } w-100` } onChange={ e =>
                                          {
                              ...
                              <div className={ `row mt-5` }>
                                    ...
                                    <div className='col d-flex align-items-center justify-content-center justify-content-sm-start'>
                                          <input defaultValue={ oldAddress ? oldAddress : '' } placeholder={ oldAddress ? oldAddress : '' } type='text' className={ `${ styles.inputs } w-100` } onChange={ e =>
                                          {
                        ...
                        <Modal.Footer className='justify-content-center'>
                              ...
                              <button className='btn btn-primary ms-sm-3 ms-2' onClick={ updateStudent }>Create</button>
                        </Modal.Footer>
                  </Modal>
                  <Modal show={ confirmPopUp } onHide={ () => setConfirmPopUp(false) } className={ `reAdjustModel hideBrowserScrollbar ${ styles.confirmModal }` } container={ props.containerRef.current }>
                        ...
                        <Modal.Body className='border border-0 d-flex justify-content-center'>
                              <h4 className='text-center'>Are you sure you want to update this student info?</h4>
                        </Modal.Body>
